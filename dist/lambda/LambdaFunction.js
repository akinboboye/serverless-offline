...
class LambdaFunction {
  ...
  constructor(functionKey, functionDefinition, serverless, options, v3Utils) {
    ...
    const timeout = (functionDefinition.timeout || provider.timeout || _index2.DEFAULT_LAMBDA_TIMEOUT) * 1000;
    ...
    _classPrivateFieldLooseBase(this, _codeDir)[_codeDir] = _classPrivateFieldLooseBase(this, _lambdaDir)[_lambdaDir] ? (0, _path.resolve)(_classPrivateFieldLooseBase(this, _lambdaDir)[_lambdaDir], 'code') : _servicePath;
  ...
  _startExecutionTimer() {
    _classPrivateFieldLooseBase(this, _executionTimeStarted)[_executionTimeStarted] = _perf_hooks.performance.now();
