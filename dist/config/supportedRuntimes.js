...
const supportedGo = new Set(['go1.x']);

// JAVA
exports.supportedGo = supportedGo;
const supportedJava = new Set(['java8', 'java11']);

// NODE.JS
exports.supportedJava = supportedJava;
const supportedNodejs = new Set([
// deprecated, but still working
'nodejs4.3', 'nodejs6.10', 'nodejs8.10',
// supported
...
const supportedPython = new Set(['python2.7', 'python3.6', 'python3.7', 'python3.8', 'python3.9']);

// RUBY
exports.supportedPython = supportedPython;
const supportedRuby = new Set(['ruby2.5', 'ruby2.7']);
