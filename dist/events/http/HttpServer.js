...
class HttpServer {
  ...
  _configureJWTAuthorization(endpoint, functionKey, method, path) {
    ...
    const scheme = (0, _createJWTAuthScheme.default)(jwtSettings, this);
  ...
  _configureAuthorization(endpoint, functionKey, method, path) {
    ...
    // Create the Auth Scheme for the endpoint
    const scheme = (0, _createAuthScheme.default)(authorizerOptions, _classPrivateFieldLooseBase(this, _serverless)[_serverless].service.provider, _classPrivateFieldLooseBase(this, _lambda)[_lambda], this);
  ...
  createRoutes(functionKey, httpEvent, handler) {
    ...
    if (httpEvent.isHttpApi) {
      if (httpEvent.routeKey === '$default') {
        ...
        hapiPath = (0, _index2.generateHapiPath)(path, {
          ..._classPrivateFieldLooseBase(this, _options)[_options],
    ...
    const hapiHandler = async (request, h) => {
      ...
      const schema = typeof (endpoint === null || endpoint === void 0 ? void 0 : (_endpoint$request = endpoint.request) === null || _endpoint$request === void 0 ? void 0 : _endpoint$request.schema) !== 'undefined' ? endpoint.request.schema[contentType] : '';
  ...
  create404Route() {
    ...
    const existingRoutes = _classPrivateFieldLooseBase(this, _server)[_server].table()
